	...
	static class SCKeywordChecker {
		...
		static SCKeywordChecker () {
			string[][] kw = new string[][] {
				new string[] { Beautify.ShaderParams.SKW_DALTONIZE, "Daltonize" },
				new string[] { Beautify.ShaderParams.SKW_LUT, "LUT 2D" },
				new string[] { Beautify.ShaderParams.SKW_LUT3D, "LUT 3D" },
				new string[] { Beautify.ShaderParams.SKW_NIGHT_VISION, "Night Vision" },
				new string[] { Beautify.ShaderParams.SKW_THERMAL_VISION, "Thermal Vision" },
				new string[] {
					Beautify.ShaderParams.SKW_DEPTH_OF_FIELD,
					"Depth of Field (DoF)"
				},
				new string[] {
					Beautify.ShaderParams.SKW_DEPTH_OF_FIELD_TRANSPARENT,
					"DoF Transp. & Exclusion"
				},
				new string[] { Beautify.ShaderParams.SKW_OUTLINE, "Outline" },
				new string[] { Beautify.ShaderParams.SKW_DIRT, "Lens Dirt" },
				new string[] { Beautify.ShaderParams.SKW_CHROMATIC_ABERRATION, "Chromatic Aberration" },
				new string[] { Beautify.ShaderParams.SKW_BLOOM, "Bloom & Flares" },
				new string[] { Beautify.ShaderParams.SKW_TONEMAP_ACES, "ACES Tonemap" },
                new string[] { Beautify.ShaderParams.SKW_TONEMAP_AGX, "AGX Tonemap" },
                new string[] { Beautify.ShaderParams.SKW_EYE_ADAPTATION, "Eye Adaptation" },
				new string[] { Beautify.ShaderParams.SKW_PURKINJE, "Purkinje" },
				new string[] { Beautify.ShaderParams.SKW_VIGNETTING, "Vignetting" },
				new string[] {
					Beautify.ShaderParams.SKW_VIGNETTING_MASK,
					"Vignetting Mask"
				},
				new string[] { Beautify.ShaderParams.SKW_FRAME, "Frame" },
				new string[] { Beautify.ShaderParams.SKW_FRAME_MASK, "Frame Mask" }
			};
